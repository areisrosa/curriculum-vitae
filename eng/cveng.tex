...
\cventry{\textbf{Jun'21 -- Oct'21}}{}{}{}{}{\textbf{Itau Bank}\\
  \textbf{Guide}: Marcos de Azevedo (Software Manager) \\
...
{\small
  ...
  \cvitem{\textbf{Tools}}{\emph{Git}, \emph{GitHub}, \emph{GitLab}, \emph{Jenkis}, \emph{Terraform}, \emph{RebbitMQ}, \emph{SQS}, \emph{GraphQL}, \emph{Vim}, \emph{Intellij}, \emph{VSCode}, QEMU, \emph{HTML5}, \emph{SCSS/CSS}, \emph{Docker}, \emph{Ks8}, \emph{AWS}, \emph{JUnit}, \emph{Jest}, \emph{RSpec}, \emph{PyTest}.}
  \cvitem{\textbf{D.B.M.S}}{\emph{MongoDB}, \emph{Redis}, \emph{PostgreSQL}, \emph{MariDb}.}
  \cvitem{\textbf{Good Habits}}{\emph{Passion for Secutiry and Learning}, \emph{SDLC}, \emph{OWASP}, \emph{Privacity by Design}, \emph{Secutiry by Design}, \emph{BDD}, \emph{TDD}, \emph{Unit Test}, \emph{Integration and Testing}, \emph{eXtreme Programming}, \emph{Scrum}, \emph{Kanban}, \emph{Design Patterns}, \emph{Clean Code}, \emph {Code Review}.}
  \par
}
