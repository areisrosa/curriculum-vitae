...
\cventry{\textbf{Jun'21 -- Out'21}}{}{}{}{}{\textbf{Banco Itaú}\\
  \textbf{Orientadora}: Marcos de Azevedo (Software Manager) \\
...
{\small
  ...
  \cvitem{\textbf{Ferramentas}}{\emph{Git}, \emph{GitHub}, \emph{GitLab}, \emph{Jenkis}, \emph{Terraform}, \emph{RebbitMQ}, \emph{SQS}, \emph{GraphQL}, \emph{Vim}, \emph{Intellij}, \emph{VSCode}, QEMU, \emph{HTML5}, \emph{SCSS/CSS}, \emph{Docker}, \emph{Ks8}, \emph{AWS}, \emph{JUnit}, \emph{Jest}, \emph{RSpec}, \emph{PyTest}.}
  \cvitem{\textbf{SGBD}}{\emph{Redis}, \emph{MongoDB}, \emph{PostgreSQL}, \emph{MariaDB}. }
  \cvitem{\textbf{Boas Práticas}}{\emph{Paixao por Segurança e Aprender}, \emph{SDLC}, \emph{OWASP}, \emph{Privacity by Design}, \emph{Secutiry by Design}, \emph{BDD}, \emph{TDD}, \emph{Unit Test}, \emph{Integration and Testing}, \emph{eXtreme Programming}, \emph{Scrum}, \emph{Kanban}, \emph{Design Patterns}, \emph{Clean Code}, \emph{Code Review}.}
\par
}%
