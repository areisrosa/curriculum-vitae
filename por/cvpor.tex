...
\title{Engenheiro de Software de Segurança \faGithub, \faStackExchange, \faStackOverflow}
\address{Rua Maria Candida, 428}{São Paulos, Brasil}%i
...
\section{Educação}
\cventry{\textbf{2020 -- 2023}}{Mestrado, Ciências da Computação}{}{}{}{Instituto de Computação (IC-Unicamp), São Paulo, Brasil.\\}
\cventry{\textbf{2014 -- 2019}}{Bacharel, Matemática Aplicada Computacional}{}{}{}{Instituto de Matemática e Estatística (IME-USP), São Paulo, Brasil.}

\section{Experiência}
\cventry{\textbf{Nov'21 -- Atual}}{Engenheiro de Software e Segurança}{}{}{}{Tempest Secutiry Intelligence, São Paulo, Brasil.\\}
\cventry{\textbf{Jun'21 -- Out'21}}{Engenheiro de Software}{}{}{}{Banco Itaú, São Paulo, Brasil.\\}
\cventry{\textbf{Out'20 -- Mai'21}}{Engenheiro de Software}{}{}{}{GetNinjas, São Paulo, Brasil.}

\section{Projetos}
\cventry{\textbf{Nov'21 -- Atual}}{}{}{}{}{\textbf{Tempest Secutiry Intelligence}\\
  \textbf{Orientadora}: Daniel Fernandes (Tech Lead) \\
  \textbf{Objetivo}: Construir aplicações seguras, criar ferramentas para automatizar infraestrutura e manter.\\
  \textbf{Descrição}: Estou desenvolvendo ferramentas para agilizar o ciclo de
  desenvolvimento de software para todos os times de engenharia, automatizar
  processos da infraestrutura que usam tecnologias e plataformas das mais
  variadas, além disso, fazendo analise na segurança das aplicações e
  ferramentas usadas no processo de produção dos softwares.
}
\cventry{\textbf{Jun'21 -- Out'21}}{}{}{}{}{\textbf{Banco Itaú}\\
  \textbf{Orientadora}: Marcos de Azevedo (Software Engineering Manager) \\
  \textbf{Objetivo}: Criar api, bibliotecas, automatizar infraestrutura e manter.\\
  \textbf{Descrição}: Eu ajudei a manter o principal software de \emph{rewards}
  dos cartões de créditos do banco , ou seja, uma plataforma de pontos e
  compras, além disso, auxilie no processo de modernização do clico de
  desenvolvimento de software no qual fizemos a migração da infraestrutura
  legada para o modelo IaaS. Além disso, implementamos recursos críticos para o
  programa \emph{rewards}, como a centralização das configurações do programa em um
  único serviço, grande refatoração da experiência do usuário, adição de um
  serviço \emph{backend}.
}
\cventry{\textbf{Out'20 -- Mai'21}}{}{}{}{}{\textbf{GetNinjas}\\
  \textbf{Orientadora}: Magno Fonseca (Tech Lead) \\
  \textbf{Objetivo}: Criar api, automatizar infraestrutura e manter.\\
  \textbf{Descrição}: Eu desenvolvi softwares (APIs) que atuam com uma variedade de tecnologias, usando microsserviços
  escaláveis horizontalmente, arquitetura hexagonal, além disso, ajudei na melhorias da infraestrutura das aplicações
  e também na segurança durante o ciclo de desenvolvimento.
}

\section{Habilidades Computacionais}
\renewcommand{\listitemsymbol}{-~}
{\small
  \cvitem{\textbf{S.O}}{\emph{Gnu/Linux}}
  \cvitem{\textbf{Frameworks}}{\emph{Spring}, \emph{RoR}, \emph{Django}, \emph{Vue}, \emph{Pacu}.}
  \cvitem{\textbf{Linguagens}}{\emph{C}, \emph{Golang}, Rust, \emph{Java}, \emph{Kotlin}, \emph{Ruby}, Javascript(ES), \emph{Shell Script}, \emph{Python}, Elixir.}
  \cvitem{\textbf{Ferramentas}}{\emph{Git}, \emph{GitHub}, \emph{GitLab}, \emph{Jenkis}, \emph{Terraform}, \emph{Helm}, \emph{Grafana}, \emph{Splunk}, \emph{RebbitMQ}, \emph{SQS}, \emph{GraphQL}, Kafka, \emph{Vim}, \emph{Intellij}, \emph{VSCode}, QEMU, \emph{HTML5}, \emph{SCSS/CSS}, \emph{Docker}, \emph{Ks8}, \emph{AWS}, \emph{JUnit}, \emph{Jest}, \emph{RSpec}, \emph{PyTest}.}
  \cvitem{\textbf{SGBD}}{\emph{Redis}, \emph{MongoDB}, \emph{PostgreSQL}, \emph{MariaDB}. }
  \cvitem{\textbf{Boas Práticas}}{\emph{Paixao por Segurança e Aprender}, \emph{GitOps}, \emph{DevSecOps}, \emph{SDLC}, \emph{OWASP}, \emph{Privacity by Design}, \emph{Secutiry by Design}, \emph{BDD}, \emph{TDD}, \emph{Unit Test}, \emph{Integration and Testing}, \emph{eXtreme Programming}, \emph{Scrum}, \emph{Kanban}, \emph{Design Patterns}, \emph{Clean Code}, \emph{Code Review}.}
\par
}%

\section{Principais Cursos Realizados}
\renewcommand{\listitemsymbol}{-~} % Changes the symbol used for lists
{\small
  \cvitem{\textbf{Ciências da Computação}}{Criação e Analise de Algoritmos, Teoria da Computação, Linguagens de Programação, Banco de Dados, Matemática Discreta, Estrutura de Dados, Grafos.}
  \cvitem{\textbf{Matemática}}{Métodos Estatísticos, Cálculo Estatísticos, Algebra Linear, Analise Real, Cálculo Vetorial, Otimização Linear and Não Linear.}
  \cvitem{\textbf{Estatística}}{Estatística Básica, Métodos Estatísticos, Métodos Estatísticos, Analise de Dados and Simulação.}
\par
}
...
{\small
  \renewcommand{\listitemsymbol}{-~}% Changes the symbol used for lists
  \cvitem{\textbf{1}}{Criptografia I - Universidade Stanford (Coursers), Dan Boneh.}%
  \cvitem{\textbf{2}}{AWS Cloud Infrastructure Security - (Tenchi Security), Rodrigo Montoro e Alexandre Sieira.}%
  \par
}%

\section{Linguagens}
\cvitemwithcomment{\textbf{Português}}{Fluente}{Ótima leitura, escrita, compreensão e fala.}
\cvitemwithcomment{\textbf{Inglês}}{Intermediário}{Boa leitura, escrita, compreensão e fala.}
